        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-4">
          {brands.map((brand, index) => (
            <motion.button
              ...
              className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-[#1E3A8A] hover:shadow-xl transition-all group hover:bg-gradient-to-br hover:from-blue-50 hover:to-white"
            >
